...
{
    public partial class DNATraceHistory : ICardType, IPackedAddress, ICardFlags
    {
        ...
        /// <summary>
        /// 0-31, if the MSB is set then value is in biCardTypEx
        /// </summary>
        public int CardType => (int)BitFields.GetDWordBits((uint)CardFlags, 0x1A06); // 6 bits at offset 26;
